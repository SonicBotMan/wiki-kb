...
created: YYYY-MM-DD
updated: YYYY-MM-DD
type: entity | concept | comparison | query | person | project | meeting | idea | tool
tags: [from taxonomy]
sources: [raw/articles/source-name.md]
status: active | draft | archived
description: 一句话描述（用于 index.md 目录和搜索摘要）
content_hash: ""  # 自动维护，Agent 写入时计算 SHA256
---
...
|-----------|----------------|
| entity | Entities (33f20cd1-794b-8141-b34f-e7374642e8b7) |
| concept | Concepts (33f20cd1-794b-8116-b769-d20620da5819) |
| comparison | Comparisons (33f20cd1-794b-8194-8543-e073dd647c3b) |
| query | Queries (33f20cd1-794b-812e-907d-e4c0f951b101) |
